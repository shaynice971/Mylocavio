...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#080B14] text-white antialiased">
      ...
      {/* ── NAVBAR ────────────────────────────────────────────────── */}
      <header className="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-[#080B14]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/connexion" className="hidden md:inline text-sm font-medium text-white/60 hover:text-white transition-colors">
              Se connecter
            </Link>
            <Link
              href="/inscription"
      ...
      <section className="relative pt-40 pb-32 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 border border-white/10 bg-white/5 text-white/60 text-xs font-medium px-4 py-2 rounded-full mb-8">
          ...
          <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto mt-8 leading-relaxed">
          ...
          <div className="mt-12 flex gap-4 justify-center flex-wrap">
            ...
            <Link
              href="/connexion"
              className="inline-flex items-center gap-2 border border-white/10 bg-white/5 hover:bg-white/10 text-white rounded-xl px-8 py-4 text-base font-medium transition-all"
            >
              Se connecter
            </Link>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto px-6 mt-20">
          <div className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden shadow-2xl shadow-black/50">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-white/3">
              ...
              <span className="ml-2 text-xs text-white/20 font-mono">mylocavio.vercel.app/dashboard</span>
            </div>
            <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                { label: "Biens gérés", value: "3", color: "text-[#2A9FD6]" },
                { label: "Loyers du mois", value: "2 400 €", color: "text-emerald-400" },
                { label: "Quittances", value: "12", color: "text-violet-400" },
                { label: "En retard", value: "0", color: "text-rose-400" },
              ].map((s) => (
            ...
            <div className="px-6 pb-6 grid grid-cols-1 md:grid-cols-3 gap-3">
              {["12 rue de la Paix · Paris", "4 allée des Roses · Lyon", "28 bd Gambetta · Nantes"].map((addr) => (
                <div key={addr} className="bg-white/3 border border-white/5 rounded-xl p-4 flex items-center gap-3">
                  ...
                  <p className="text-white/50 text-xs truncate">{addr}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-center gap-5">
          <div className="flex -space-x-2.5">
            {["MD", "TR", "SM", "JL", "AB"].map((i) => (
              <div key={i} className="w-9 h-9 rounded-full bg-gradient-to-br from-[#2A9FD6] to-[#1a7aaa] text-white font-bold text-xs flex items-center justify-center ring-2 ring-[#080B14]">
                {i}
              </div>
            ))}
          </div>
          <p className="text-sm text-white/40">
            <span className="font-semibold text-white">+200 propriétaires</span> ont simplifié leur gestion locative avec MyLocavio
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mt-4 leading-tight">
              Opérationnel en<br /><span className="text-white/40">moins de 5 minutes</span>
            </h2>
          </div>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={step.n} className="relative group">
                <div className="border border-white/8 bg-white/3 hover:bg-white/5 rounded-2xl p-8 transition-all hover:border-white/15">
                  <span className="text-[80px] font-black text-white/5 leading-none block mb-4">{step.n}</span>
                  <h3 className="text-xl font-bold text-white">{step.title}</h3>
                  <p className="text-white/40 mt-2 text-sm leading-relaxed">{step.desc}</p>
                </div>
                {i < 2 && (
      ...
      {/* ── FEATURES ──────────────────────────────────────────────── */}
      <section id="fonctionnalites" className="py-28 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto">
            <p className="text-[#2A9FD6] text-xs font-bold tracking-[0.2em] uppercase">Fonctionnalités</p>
            <h2 className="text-4xl md:text-5xl font-black text-white mt-4 leading-tight">
              Tout ce qu&apos;un bailleur<br /><span className="text-white/40">indépendant doit avoir</span>
            </h2>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f) => {
              ...
              return (
                <div
                  key={f.title}
                  className="group relative border border-white/8 bg-white/3 hover:bg-white/5 hover:border-white/15 rounded-2xl p-7 transition-all"
                >
      ...
      {/* ── PRICING ───────────────────────────────────────────────── */}
      <section id="tarifs" className="py-28 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto">
            <p className="text-[#2A9FD6] text-xs font-bold tracking-[0.2em] uppercase">Tarification</p>
            <h2 className="text-4xl md:text-5xl font-black text-white mt-4 leading-tight">
              Des tarifs honnêtes,<br /><span className="text-white/40">sans surprise</span>
            </h2>
            <p className="text-white/40 mt-4 text-sm">Commencez gratuitement. Résiliez quand vous voulez.</p>
          </div>
              ...
              <div
                ...
                className={`relative rounded-2xl p-8 flex flex-col transition-all ${
                  plan.highlight
                    ...
                    : "border border-white/8 bg-white/3 hover:bg-white/5 hover:border-white/15"
                }`}
              >
                {plan.badge && (
                ...
                <div>
                  ...
                  <p className="text-white/40 text-sm mt-0.5">{plan.desc}</p>
                  <div className="mt-6 flex items-end gap-1">
                    <span className="text-5xl font-black text-white">{plan.price}</span>
                    <span className="text-white/40 text-sm mb-2">€/mois</span>
                  </div>
                </div>
                <div className="mt-6 pt-6 border-t border-white/8 flex-1">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mt-4">
              Ils ont simplifié<br /><span className="text-white/40">leur gestion locative</span>
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((t) => (
              <div key={t.name} className="border border-white/8 bg-white/3 hover:bg-white/5 hover:border-white/15 rounded-2xl p-7 transition-all">
      ...
      <section id="faq" className="py-28 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-white mt-4">Questions fréquentes</h2>
          </div>
          ...
          <div className="space-y-2">
            {faqItems.map((item, idx) => (
              <details
                key={idx}
                className="group border border-white/8 bg-white/3 open:border-white/15 open:bg-white/5 rounded-xl transition-all"
              >
                <summary className="flex items-center justify-between px-6 py-4 cursor-pointer list-none font-semibold text-white text-sm gap-4">
                  <span>{item.q}</span>
                  <svg className="w-4 h-4 text-white/30 shrink-0 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </summary>
                <div className="px-6 pb-5 text-white/40 text-sm leading-relaxed">
                  {item.a}
                </div>
              </details>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              return (
                <div key={item.title} className="border border-white/8 bg-white/3 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-white/35 text-xs mt-2 leading-relaxed">{item.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-28 border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="relative">
            ...
            <div className="relative border border-white/8 bg-white/3 rounded-3xl p-16">
              ...
              <p className="text-white/40 text-lg mt-5">
              ...
              <p className="text-white/20 text-xs mt-4">Gratuit · Sans engagement · Résiliation en 1 clic</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-white/20 text-xs mt-5">&copy; 2026 MyLocavio</p>
            </div>
            <div>
              <h4 className="font-bold text-white text-sm mb-5">Produit</h4>
              <ul className="space-y-3">
                {["Dashboard", "Mes biens", "Quittances", "Baux", "États des lieux"].map((l) => (
                  <li key={l}><a href="#" className="text-white/35 text-sm hover:text-white transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-white text-sm mb-5">Ressources</h4>
              <ul className="space-y-3">
                {[{ l: "Centre d'aide", h: "#" }, { l: "Blog", h: "#" }, { l: "Guide ALUR", h: "#" }, { l: "Contact", h: "#" }].map((i) => (
                  <li key={i.l}><a href={i.h} className="text-white/35 text-sm hover:text-white transition-colors">{i.l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-white text-sm mb-5">Légal</h4>
              <ul className="space-y-3">
          ...
          <div className="border-t border-white/5 pt-8">
            <p className="text-white/20 text-xs text-center">Fait avec soin pour les propriétaires français</p>
          </div>
        </div>
      </footer>
    </div>
