  ...
  return (
    <div className="border border-gray-200 bg-white shadow-sm backdrop-blur-sm rounded-2xl p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-gray-500 mb-1.5">Nouveau mot de passe *</label>
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-500 mb-1.5">Confirmer le mot de passe *</label>
